...
<div class="d-flex flex-column gap-4">
    ...
    <nav class="d-flex align-items-center gap-2 text-sm text-secondary">
        ...
        <span class="text-dark fw-bold">Akademi Collection</span>
    </nav>
    ...
    <div class="position-relative bg-gradient-brand rounded-5 p-4 p-md-5 text-white overflow-hidden shadow">
        ...
        <div class="position-relative z-1 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-4">
            <div class="flex-grow-1">
                ...
                <h1 class="fw-bolder mb-2 h2">Akademi Collection</h1>
                <p class="mb-4 small text-white-50" style="max-width: 500px;">Pelajari teknik negosiasi, regulasi penagihan, manajemen Non-Performing Loan (NPL), dan strategi recovery aset secara komprehensif.</p>

                <div class="d-flex flex-wrap gap-4">
                    <div>
                        <p class="text-xs text-white-50 mb-1">Total Progress</p>
                        <p class="h4 fw-bold mb-0">15%</p>
                    </div>
            ...
            <div class="w-100" style="max-width: 200px;">
                <div class="progress bg-white bg-opacity-10 rounded-pill mb-2" style="height: 10px;">
                    <div class="progress-bar bg-success rounded-pill" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-xs text-white-50 text-md-end mb-0">15% selesai</p>
            </div>
        </div>
        ...
        <div class="col-lg-5 d-flex flex-column gap-3">
            ...
            <div class="card rounded-4 border-2 border-primary border-opacity-50 shadow cursor-pointer">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-brand text-sm mb-1">Collection Basic</h4>
                        <p class="text-xs text-muted mb-2">Certified Collection Basic Officer (CCBO)</p>
                        <div class="d-flex align-items-center gap-2">
                            <div class="progress flex-grow-1 rounded-pill" style="height: 6px;">
                                <div class="progress-bar bg-primary rounded-pill" style="width: 20%"></div>
                            </div>
                            <span class="text-xs fw-bold text-primary">20%</span>
                        </div>
                    </div>
            ...
            <div class="card rounded-4 border border-secondary border-opacity-25 bg-light opacity-75 border-dashed">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-secondary text-sm mb-1">Collection Professional</h4>
                        <p class="text-xs text-muted mb-1">Certified Collection Professional (CCP)</p>
            ...
            <div class="card rounded-4 border border-secondary border-opacity-25 bg-light opacity-75 border-dashed">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-secondary text-sm mb-1">Collection Master</h4>
                        <p class="text-xs text-muted mb-1">Certified Collection Manager (CCM)</p>
                    </div>
                    <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3 py-2">Terkunci</span>
                </div>
            </div>
        ...
        <div class="col-lg-7">
            <div class="card rounded-4 border-0 shadow-sm overflow-hidden">
                <div class="card-header bg-white border-bottom p-4 p-md-5">
                    ...
                    <h2 class="h5 fw-bold text-dark mt-1">Collection Basic</h2>
                    <p class="text-sm text-muted">Pemahaman dasar mengenai regulasi penagihan, pendekatan persuasif, dan administrasi penyelesaian kredit bermasalah.</p>
                    
                    <div class="d-flex flex-wrap gap-4 mt-4 text-sm">
                        <div>
                            <p class="text-xs text-muted mb-1">Sertifikat</p>
                            <p class="fw-bold text-dark mb-0">Certified Collection Basic</p>
                        </div>
                        <div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex flex-column gap-3 mb-4">
                        @php
                            $modules = [
                                ['code'=>'COL01','title'=>'Dasar Penagihan & Regulasi OJK','duration'=>'6 Jam','soal'=>'25 Soal','status'=>'done'],
                                ['code'=>'COL02','title'=>'Teknik Komunikasi & Negosiasi Persuasif','duration'=>'8 Jam','soal'=>'30 Soal','status'=>'active'],
                                ['code'=>'COL03','title'=>'Penanganan Kredit Bermasalah (NPL)','duration'=>'6 Jam','soal'=>'30 Soal','status'=>'locked'],
                            ];
                        @endphp
                        ...
                        <div class="d-flex align-items-center gap-3 p-3 rounded-4 bg-light border border-secondary border-opacity-10 mt-2 opacity-50">
                            ...
                            <div class="flex-grow-1">
                                <h4 class="text-sm fw-bold text-secondary mb-1">Ujian Level 1 - Collection Basic</h4>
