...
@section('content')
<!-- Custom Styles untuk meniru utilitas spesifik Tailwind yang tidak ada di Bootstrap -->
<style>
    .bg-gradient-brand {
        background: linear-gradient(135deg, #0a1f5c, #0f2557, #1a3a7c);
    }
...
<div class="d-flex flex-column gap-4">
    ...
    <nav class="d-flex align-items-center gap-2 text-sm text-secondary">
        ...
        <span class="text-dark fw-bold">Akademi Funding</span>
    </nav>
    ...
    <div class="position-relative bg-gradient-brand rounded-5 p-4 p-md-5 text-white overflow-hidden shadow">
        ...
        <div class="position-relative z-1 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-4">
            <div class="flex-grow-1">
                ...
                <h1 class="fw-bolder mb-2 h2">Akademi Funding</h1>
                <p class="mb-4 small text-white-50" style="max-width: 500px;">Pelajari strategi penghimpunan dana, produk funding, digital marketing, dan pengelolaan likuiditas secara komprehensif.</p>

                <!-- Stats row -->
                <div class="d-flex flex-wrap gap-4">
                    <div>
                        <p class="text-xs text-white-50 mb-1">Total Progress</p>
                        <p class="h4 fw-bold mb-0">68%</p>
                    </div>
                    <div class="border-start border-light border-opacity-25 ps-4">
                        <p class="text-xs text-white-50 mb-1">Sertifikat</p>
                        <p class="h4 fw-bold mb-0">2 / 3</p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-100" style="max-width: 200px;">
                <div class="progress bg-white bg-opacity-10 rounded-pill mb-2" style="height: 10px;">
                    <div class="progress-bar bg-success rounded-pill" role="progressbar" style="width: 68%" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="text-xs text-white-50 text-md-end mb-0">68% selesai</p>
            </div>
        </div>
    ...
    <div class="row g-4 mt-1">
        ...
        <div class="col-lg-5 d-flex flex-column gap-3">
            ...
            <!-- Level 1 Selesai -->
            <div class="card rounded-4 border-2 border-success border-opacity-25 shadow-sm cursor-pointer">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    <div class="bg-success-subtle rounded-3 d-flex flex-column align-items-center justify-content-center flex-shrink-0" style="width: 3rem; height: 3rem;">
                        <span class="text-success fw-bolder text-xs">L1</span>
                    </div>
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-dark text-sm mb-1">Funding Basic</h4>
                        <p class="text-xs text-muted mb-2">Certified Funding Basic Officer (CFBO)</p>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-xs fw-bold text-success">100%</span>
                        </div>
                    </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="bg-primary-subtle rounded-3 d-flex flex-column align-items-center justify-content-center flex-shrink-0 border border-2 border-primary" style="width: 3rem; height: 3rem;">
                            <span class="text-primary fw-bolder text-xs">L2</span>
                        </div>
                        <div class="flex-grow-1 min-vw-0">
                            <h4 class="fw-bold text-brand text-sm mb-1">Funding Professional</h4>
                            <p class="text-xs text-muted mb-0">Certified Funding Professional (CFP)</p>
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="progress flex-grow-1 rounded-pill" style="height: 8px;">
                            <div class="progress-bar bg-primary rounded-pill" style="width: 60%"></div>
                        </div>
                        <span class="text-xs fw-bold text-primary">60%</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card rounded-4 border border-secondary border-opacity-25 bg-light opacity-75 border-dashed">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-secondary text-sm mb-1">Funding Master</h4>
                        <p class="text-xs text-muted mb-1">Certified Funding Manager (CFM)</p>
                        <p class="text-xs text-muted mb-0 d-flex align-items-center gap-1">
                            ...
                            Selesaikan Level 2 untuk membuka
                        </p>
                    </div>
        ...
        <div class="col-lg-7">
            <div class="card rounded-4 border-0 shadow-sm overflow-hidden">
                <div class="card-header bg-white border-bottom p-4 p-md-5">
                    ...
                    <h2 class="h5 fw-bold text-dark mt-1">Funding Basic</h2>
                    <p class="text-sm text-muted">Program dasar untuk memahami fundamental funding dan produk perbankan.</p>
                    
                    <div class="d-flex flex-wrap gap-4 mt-4 text-sm">
                        <div>
                            <p class="text-xs text-muted mb-1">Sertifikat</p>
                            <p class="fw-bold text-dark mb-0">Certified Funding Basic Officer (CFBO)</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="fw-bold text-dark mb-0">20 Jam</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex flex-column gap-3 mb-4">
                        @php
                            $modules = [
                                ['code'=>'F01','title'=>'Fundamental Perbankan dan Funding','duration'=>'6 Jam','soal'=>'25 Soal','status'=>'done'],
                                ['code'=>'F02','title'=>'Product Knowledge Funding','duration'=>'8 Jam','soal'=>'30 Soal','status'=>'done'],
                                ['code'=>'F03','title'=>'Regulasi Funding dan LPS','duration'=>'4 Jam','soal'=>'30 Soal','status'=>'done'],
                            ];
                        @endphp
                        
                        @foreach($modules as $m)
                        <div class="d-flex align-items-center gap-3 p-3 rounded-4 {{ $m['status']=='done' ? 'bg-light' : 'border border-primary-subtle bg-primary-subtle' }} cursor-pointer">
                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 {{ $m['status']=='done' ? 'bg-success-subtle' : 'bg-white' }}" style="width: 2.5rem; height: 2.5rem;">
                                @if($m['status']=='done')
                        ...
                        <!-- Ujian Final -->
                        <div class="d-flex align-items-center gap-3 p-3 rounded-4 bg-warning-subtle border border-warning mt-2">
                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 bg-white" style="width: 2.5rem; height: 2.5rem;">
                                <svg style="width: 16px; height: 16px;" class="text-warning" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                            </div>
                            <div class="flex-grow-1">
                                <h4 class="text-sm fw-bold text-dark mb-1">Ujian Level 1 - Funding Basic</h4>
                                <p class="text-xs text-warning-emphasis mb-0">Final Exam &middot; 60 Soal</p>
                            </div>
                            <span class="text-sm fw-bold text-success">Lulus</span>
                        </div>
                    </div>

                    <!-- Footer Action -->
                    <div class="mt-4 pt-4 border-top d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
                            <div class="bg-success rounded-circle" style="width: 10px; height: 10px;"></div>
                            <span class="text-xs text-muted fw-medium">Progress Level: <strong class="text-success">100%</strong></span>
                        </div>
                        <a href="#" class="btn bg-brand text-white text-xs fw-bold px-4 py-2 rounded-3">Lihat Sertifikat</a>
                    </div>
                </div>
            </div>
        </div>
