...
<div class="d-flex flex-column gap-4">
    ...
    <nav class="d-flex align-items-center gap-2 text-sm text-secondary">
        ...
        <span class="text-dark fw-bold">Akademi Service</span>
    </nav>
    ...
    <div class="position-relative bg-gradient-brand rounded-5 p-4 p-md-5 text-white overflow-hidden shadow">
        ...
        <div class="position-relative z-1 d-flex flex-column flex-md-row align-items-start align-items-md-center gap-4">
            <div class="flex-grow-1">
                ...
                <h1 class="fw-bolder mb-2 h2">Akademi Service</h1>
                <p class="mb-4 small text-white-50" style="max-width: 500px;">Pelajari standar pelayanan prima (Service Excellence), komunikasi efektif, penanganan keluhan nasabah, dan operasional layanan front-liner.</p>

                <div class="d-flex flex-wrap gap-4">
                    <div>
                        <p class="text-xs text-white-50 mb-1">Total Progress</p>
                        <p class="h4 fw-bold mb-0">40%</p>
                    </div>
            ...
            <div class="w-100" style="max-width: 200px;">
                ...
                <p class="text-xs text-white-50 text-md-end mb-0">40% selesai</p>
            </div>
        </div>
        ...
        <div class="col-lg-5 d-flex flex-column gap-3">
            ...
            <div class="card rounded-4 border-2 border-primary border-opacity-50 shadow cursor-pointer">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-brand text-sm mb-1">Service Basic</h4>
                        <p class="text-xs text-muted mb-2">Certified Service Basic Officer (CSBO)</p>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="text-xs fw-bold text-primary">40%</span>
                        </div>
                    </div>
            ...
            <div class="card rounded-4 border border-secondary border-opacity-25 bg-light opacity-75 border-dashed">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-secondary text-sm mb-1">Service Professional</h4>
                        <p class="text-xs text-muted mb-1">Certified Service Professional (CSP)</p>
            ...
            <div class="card rounded-4 border border-secondary border-opacity-25 bg-light opacity-75 border-dashed">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1 min-vw-0">
                        <h4 class="fw-bold text-secondary text-sm mb-1">Service Master</h4>
                        <p class="text-xs text-muted mb-1">Certified Service Manager (CSM)</p>
                    </div>
                    <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3 py-2">Terkunci</span>
                </div>
            </div>
        ...
        <div class="col-lg-7">
            <div class="card rounded-4 border-0 shadow-sm overflow-hidden">
                <div class="card-header bg-white border-bottom p-4 p-md-5">
                    ...
                    <h2 class="h5 fw-bold text-dark mt-1">Service Basic</h2>
                    <p class="text-sm text-muted">Pemahaman dasar mengenai standar pelayanan prima, etiket berbusana (grooming), dan cara menangani keluhan nasabah.</p>
                    
                    <div class="d-flex flex-wrap gap-4 mt-4 text-sm">
                        <div>
                            <p class="text-xs text-muted mb-1">Sertifikat</p>
                            <p class="fw-bold text-dark mb-0">Certified Service Basic Officer</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="fw-bold text-dark mb-0">22 Jam</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex flex-column gap-3 mb-4">
                        @php
                            $modules = [
                                ['code'=>'S01','title'=>'Mindset & Standar Service Excellence','duration'=>'6 Jam','soal'=>'25 Soal','status'=>'done'],
                                ['code'=>'S02','title'=>'Komunikasi Efektif & Handling Complaint','duration'=>'8 Jam','soal'=>'30 Soal','status'=>'active'],
                                ['code'=>'S03','title'=>'Grooming & Etiket Pelayanan','duration'=>'4 Jam','soal'=>'20 Soal','status'=>'locked'],
                                ['code'=>'S04','title'=>'Operasional Dasar CS & Teller','duration'=>'4 Jam','soal'=>'20 Soal','status'=>'locked'],
                            ];
                        @endphp
                        ...
                        <div class="d-flex align-items-center gap-3 p-3 rounded-4 bg-light border border-secondary border-opacity-10 mt-2 opacity-50">
                            ...
                            <div class="flex-grow-1">
                                <h4 class="text-sm fw-bold text-secondary mb-1">Ujian Level 1 - Service Basic</h4>
